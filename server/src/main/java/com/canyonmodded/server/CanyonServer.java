package com.canyonmodded.server;

import com.canyonmodded.server.network.beta.MinecraftBetaDecoder;
import com.canyonmodded.server.network.beta.MinecraftBetaEncoder;
import com.canyonmodded.server.network.beta.handler.HandshakeSessionHandler;
import com.canyonmodded.server.network.beta.handler.MinecraftBetaConnection;
...
public class CanyonServer {
    private static final Logger logger = LogManager.getLogger(CanyonServer.class);
